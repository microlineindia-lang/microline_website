...
const apps = [
  {
    ...
    items: [
      ...
      "Antenna testing for missiles",
      "Communication jamming analysis",
    ],
  },
  {
    ...
    items: [
      ...
      "RF component qualification",
      "Thermal vacuum compatible assemblies",
  ...
  },
  {
    ...
    items: [
      "ADAS radar testing",
      "77 GHz antenna measurement",
      "Compact range testing",
      "OTA testing solutions",
    ],
  },
];
        ...
        <section className="page-hero bg-gradient-dark">
          <div
            ...
            style={{
              backgroundImage: `url(${
                isDarkMode
                  ? applicationsHeroDark
                  : applicationsHeroLight
              })`,
            }}
          />
          ...
          <div className="container">
            <div className="services-intro mb-12">
              <div className="text-center">
                ...
                <p>
                  From defence to automotive, our
                  RF and microwave expertise
                  spans critical industries that
                  demand precision, reliability,
                  and performance.
                </p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="mb-4">
                Our engineers can design custom
