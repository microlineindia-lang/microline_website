...
export default function ProductDetail() {
  ...
  // Image modal state & zoom logic (unchanged)
  ...
  const handleMouseDown = (e: React.MouseEvent) => {
    e.preventDefault();
    if (e.button === 0) zoomIn(e.clientX, e.clientY);
    else if (e.button === 2) zoomOut(e.clientX, e.clientY);
    if (scale > 1) {
      setIsDragging(true);
  ...
  // Minimap viewport calc (unchanged)
        ...
        <div className="product-detail-hero bg-gradient-dark">
          ...
          <div className="container position-relative z-1">
            ...
            >
              ...
              <Link to="/products" className="breadcrumb-link text-info">
                Products
              </Link>
          ...
          <div className="container">
            ...
            {(() => {
              const relatedProducts = allProducts
                .filter(
                  (rel) =>
                    rel.category.name === p.category.name && rel.slug !== p.slug
                )
                .slice(0, 3);
