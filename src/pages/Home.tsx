...
======================================== */
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Microline India | Microwave & RF Solutions</title>
        ...
        <meta property="og:title" content="Microline India" />
      ...
      <section className="hero">
        <div className="container">
          ...
          <div className="hero-text">
            <p className="hero-tag">Welcome to Microline India</p>
            ...
            <p>
              Delivering advanced microwave and RF solutions with innovation,
      ...
      <section className="section bg-light">
        <div className="container">
          <div className="section-title">
            ...
            <h2>
              Our
              <span className="text-accent"> Product Categories</span>
            </h2>
          </div>
      ...
      <div className="card-body">
        ...
        <div className="text-center pt-4">
          <button
            ...
            className="btn btn-primary"
          >
            View Products <i className="fas fa-arrow-right ms-2"></i>
          </button>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          <div className="section-title">
            <h2>
              Our Esteemed
              <span className="text-accent"> Clients & Partners</span>
            </h2>
          </div>
      ...
      <section className="section bg-light">
        <div className="container">
          <div className="section-title">
            <h2>
              Why Choose
              <span className="text-accent"> Microline India?</span>
            </h2>
          </div>
